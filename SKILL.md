...
9. Use `assets/fonts/asobi-memogaki/AsobiMemogaki-Regular-1-02.ttf` for every English and Japanese fragment. Validate glyph coverage and render deterministically with restrained per-glyph rotation, baseline drift, and loose tracking. Never model-generate letters.
...
- All text uses the bundled AsobiMemogaki font with no missing glyphs.
